...
class ExportWizard {
	...
	/**
	 * Fetch preview data for the selected data source and fields.
	 * @return void
	 */
		...
		if ( $data_source === 'product' ) {
			...
			foreach ( $products as $product ) {
				...
				if ( $wc_product->is_type( 'variable' ) ) {
					$variation_args = [ 'post_type'      => 'product_variation',
	...
	/**
	 * Fetch product types for the selected data source.
	 * @return void
	 */
	...
	/**
	 * Fetch user roles for the selected data source.
	 * @return void
	 */
	...
	/**
	 * Fetch order statuses for the selected data source.
	 * @return void
	 */
	...
	/**
	 * Fetch product statuses for the selected data source.
	 * @return bool
	 */
	...
	/**
	 * Fetch users for the selected data source.
	 * @return bool
	 */
	...
	/**
	 * Fetch orders for the selected data source.
	 * @return bool
	 */
