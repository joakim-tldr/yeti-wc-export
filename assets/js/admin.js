    ...
    YWCE.fetchDataFields = function () {
        ...
        fetch(
            ...
            .then((data) => {
                ...
                YWCE.state.selectedFields = Array.from(document.querySelectorAll('#ywce-data-fields option:checked')).map(function (o) {
                    return o.value;
                });
                YWCE.state.selectedMeta = Array.from(document.querySelectorAll('#ywce-meta-fields option:checked')).map(function (o) {
                    return o.value;
                });
                YWCE.state.selectedTaxonomies = Array.from(document.querySelectorAll('#ywce-taxonomy-fields option:checked')).map(function (o) {
                    return o.value;
                });
